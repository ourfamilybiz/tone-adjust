    ...
    <section id="use-cases" className="py-16 md:py-24">
      <div className="container max-w-3xl">
        <div className="text-center mb-10 md:mb-14 space-y-2">
          ...
          <p className="text-muted-foreground text-sm md:text-base">From quick texts to important emails.</p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
          {cases.map((c, i) => (
            <div
              key={i}
              className="bg-card rounded-xl border border-border/60 p-5 space-y-2.5 hover:shadow-soft transition-shadow duration-200"
            >
